        ...
        <template #pagi>
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-4">
              <div v-for="i in 3" :key="i" class="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                  <div class="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center text-slate-400">
                    <ArchiveBoxIcon class="w-5 h-5" />
                  </div>
                  <div>
                    <h4 class="text-sm font-bold text-slate-800">SKU-00{{ i }} Extra Joss</h4>
                    <p class="text-[10px] text-slate-400 font-bold uppercase">Target: 100 pcs</p>
                  </div>
                </div>
