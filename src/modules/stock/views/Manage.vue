<template>
  <div class="min-h-screen bg-slate-50/50 pb-24">
    ...
    >
      <div v-if="selectedMerchantId" class="sticky top-12 z-30 bg-white/80 backdrop-blur-md border-b border-slate-100 px-4 py-3 shadow-sm flex items-center justify-between mb-6">
    ...
    <div class="px-4 space-y-8 mt-6">
      <!-- Top Section: Pilih Merchant -->
      <section>
        <div class="flex items-center justify-between mb-4">
          <div>
            <h1 class="text-2xl font-black text-slate-900">Stok</h1>
            <p class="text-xs text-slate-500 font-medium">Kelola alur stok harian mitra merchant.</p>
          </div>
        </div>
