<template>
  <nav class="fixed bottom-0 left-0 right-0 h-16 bg-white border-t border-slate-100 flex items-center justify-around z-50 md:hidden px-2">
    <router-link 
...
const navItems = [
  ...
  { name: 'Stok', path: '/stock', icon: ArchiveBoxIcon },
